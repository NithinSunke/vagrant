...
echo "******************************************************************************"
yum install -y /nfsshare/soft/12102/grid/rpm/cvuqdisk-1.0.9-1.rpm
ssh root@${NODE2_HOSTNAME} yum install -y /nfsshare/soft/12102/grid/rpm/cvuqdisk-1.0.9-1.rpm
...
su - oracle -c 'sh /vagrant/scripts/asm_diskgroup.sh'
